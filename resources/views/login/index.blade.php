                ...
                <div class="w-full relative">
                    <div class="mt-6">
                        ...
                        <form action="{{ route('postlogin') }}" method="post" class="mt-6">
                            {{ csrf_field() }}
                            <h1 class="text-center text-3xl font-bold text-black">Sign In</h1>
                            <div class="mx-auto max-w-lg mt-2">
                                <div class="py-2">
                                    <span class="px-1 text-base text-white">Username</span>
                                    <input placeholder="Masukan Username" type="text" id="username" name="username"
